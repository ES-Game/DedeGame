...
class StoryBookmarkView(context: Context?, attrs: AttributeSet?) : BaseConstraintView(context, attrs) {
    ...
    private fun setupToolbar() {
        ...
        txtStartTitle.text = context.getString(R.string.stories_followed_title)
    }
