package com.dede.dedegame.presentation.widget.decimalRatingBar;
 ...
 */
public class DecimalRatingBar extends View {
  ...
  public DecimalRatingBar(Context context) {
    super(context);
    initView();
  }

  public DecimalRatingBar(Context context, AttributeSet attrs) {
    super(context, attrs);
    parseAttrs(attrs);
    initView();
  }

  public DecimalRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void animateRating(AnimationBuilder builder) {
    ...
    ratingAnimator.addListener(new AnimatorListener() {
      ...
      public void onAnimationEnd(Animator animator) {
        if (ratingListener != null) {
          ratingListener.onRatingChanged(DecimalRatingBar.this, rating, false);
        }
      }
  ...
  public interface OnRatingBarChangeListener {
     ...
     * lifting the touch.
     *
     * @param decimalRatingBar The RatingBar whose rating has changed.
     * @param rating The current rating. This will be in the range
     *            0..numStars.
     * @param fromUser True if the rating change was initiated by a user's
     *            touch gesture or arrow key/horizontal trackbell movement.
     */
    void onRatingChanged(DecimalRatingBar decimalRatingBar, float rating, boolean fromUser);
  ...
  public class AnimationBuilder {
    private DecimalRatingBar ratingBar;
    ...
    private AnimationBuilder(DecimalRatingBar ratingBar) {
