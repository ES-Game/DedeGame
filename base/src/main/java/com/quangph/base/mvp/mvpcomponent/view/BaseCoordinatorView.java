...
public class BaseCoordinatorView extends CoordinatorLayout implements IView {
    ...
    public BaseCoordinatorView(@NonNull Context context) {
        super(context);
    }

    public BaseCoordinatorView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseCoordinatorView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
