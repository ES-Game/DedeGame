 ...
 */
public class BaseDrawerLayout extends DrawerLayout implements IView {
    ...
    public BaseDrawerLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
