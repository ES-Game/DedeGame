...
public class BaseLinearView extends LinearLayout implements IView {
    ...
    public BaseLinearView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseLinearView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BaseLinearView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
