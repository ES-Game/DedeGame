...
public interface IState {
    /**
     * Returned by receiveMessage to indicate the the message was processed.
     */
    static final boolean HANDLED = true;
    /**
     * Returned by receiveMessage to indicate the the message was NOT processed.
     */
     ...
     * is needed as only one receiveMessage method will ever be
