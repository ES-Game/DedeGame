package com.quangph.base.statemachine.core;
 ...
 * <code>receiveMessage</code> and optionally <code>enter/exit/getName</code>.
 ...
 * is the initial state. After construction the programmer calls <code>startStateMachine</code>
 ...
 * of the StateMachines Handler not in the context of the call to startStateMachine and they
 ...
 * in our simple state machine below that would initially be mS1.receiveMessage.</p>
 * <code>
 * mP1
 * /   \
 ...
 * machine using <code>receiveMessage</code> and the messages are created using
 * <code>obtainMessage</code>. When the state machine receives a message the
 * current state's <code>receiveMessage</code> is invoked. In the above example
 * mS1.receiveMessage will be invoked first. The state may use <code>transitionTo</code>
 ...
 * <p>
 * <p>In addition to <code>receiveMessage</code> each <code>State</code> has
 ...
 * So the order of calling receiveMessage when a message is received is mS5,
 * mS1, mP1, mP0 assuming each receiveMessage indicates it can't handle this
 * message by returning false or NOT_HANDLED.</p>
 * <p>
 * <p>Now assume mS5.receiveMessage receives a message it can handle, and during
 ...
 * receiveMessage the state machine runtime will find the common parent,
 * which is mP1. It will then call mS5.exit, mS1.exit, mS2.enter and then
 * mS4.enter. The new list of active states is mP0, mP1, mS2 and mS4. So
 * when the next message is received mS4.receiveMessage will be invoked.</p>
 * <p>
 ...
 * hw.startStateMachine();
 * return hw;
 * }
 * class State1 extends State {
 * &#64;Override public boolean receiveMessage(Message message) {
 ...
 * hw.receiveMessage(hw.obtainMessage());
 * }
 * </code>
 ...
 * &#64;Override public boolean receiveMessage(Message message) {
 * boolean retVal;
 * Log.d(TAG, "mP1.receiveMessage what=" + message.what);
 * switch(message.what) {
 * case CMD_2:
 * // CMD_2 will arrive in mS2 before CMD_3
 * receiveMessage(obtainMessage(CMD_3));
 ...
 * }
 * &#64;Override public boolean receiveMessage(Message message) {
 * Log.d(TAG, "S1.receiveMessage what=" + message.what);
 ...
 * &#64;Override public boolean receiveMessage(Message message) {
 * boolean retVal;
 * Log.d(TAG, "mS2.receiveMessage what=" + message.what);
 * switch(message.what) {
 * case(CMD_2):
 * receiveMessage(obtainMessage(CMD_4));
 * retVal = HANDLED;
 * break;
 * case(CMD_3):
 * deferMessage(message);
 ...
 * &#64;Override public void enter() {
 * Log.d(TAG, "mP2.enter");
 * receiveMessage(obtainMessage(CMD_5));
 * }
 * &#64;Override public boolean receiveMessage(Message message) {
 * Log.d(TAG, "P2.receiveMessage what=" + message.what);
 * switch(message.what) {
 * case(CMD_3):
 * break;
 * case(CMD_4):
 ...
 * Hsm1 hsm = makeHsm1();
 * synchronize(hsm) {
 * hsm.receiveMessage(obtainMessage(hsm.CMD_1));
 * hsm.receiveMessage(obtainMessage(hsm.CMD_2));
 * try {
 ...
 * D/hsm1    ( 1999): mS1.receiveMessage what=1
 * D/hsm1    ( 1999): mS1.exit
 * D/hsm1    ( 1999): mS1.enter
 * D/hsm1    ( 1999): mS1.receiveMessage what=2
 * D/hsm1    ( 1999): mP1.receiveMessage what=2
 * D/hsm1    ( 1999): mS1.exit
 * D/hsm1    ( 1999): mS2.enter
 * D/hsm1    ( 1999): mS2.receiveMessage what=2
 * D/hsm1    ( 1999): mS2.receiveMessage what=3
 * D/hsm1    ( 1999): mS2.exit
 * D/hsm1    ( 1999): mP1.exit
 * D/hsm1    ( 1999): mP2.enter
 * D/hsm1    ( 1999): mP2.receiveMessage what=3
 * D/hsm1    ( 1999): mP2.receiveMessage what=4
 * D/hsm1    ( 1999): mP2.receiveMessage what=5
...
public class StateMachine {
    ...
    /**
     * Message.what name when quitting
     */
    private static final int SM_QUIT_CMD = -1;
    /**
     * Message.what name when initializing
     */
    private static final int SM_INIT_CMD = -2;
    /**
     * Convenience constant that maybe returned by receiveMessage
    ...
    public static class LogRec {
         ...
         */
        LogRec(Message msg, String info, IState state, IState orgState) {
         ...
         *                 did not processes the message.
         */
        public void update(Message msg, String info, IState state, IState orgState) {
     ...
     * recently processed. The list is finite and may be onObserve in the
     ...
     * the last setSize, create which returns a record and
    ...
    private static class LogRecords {
        ...
        /**
         * @return the total number of records processed since size was onObserve.
         */
         ...
         *                    did not processes the message.
         */
        synchronized void add(Message msg, String messageInfo, IState state, IState orgState) {
            mCount += 1;
    ...
    private static class SmHandler extends Handler {
         ...
         */
        private HashMap<IState, StateInfo> mStateInfo =
                new HashMap<IState, StateInfo>();
        /**
         ...
         * the current state's receiveMessage. It also handles
        ...
        public final void handleMessage(Message msg) {
            ...
            if (mIsConstructionCompleted) {
                ...
                throw new RuntimeException("StateMachine.handleMessage: " +
                        "The startStateMachine method not called, received msg: " + msg);
            }
            performTransitions();
            if (mDbg) Log.d(TAG, "handleMessage: X");
        }

        public @Nullable IState getParent(IState child) {
            StateInfo info = mStateInfo.get(child);
            if (info == null) {
                return null;
            } else {
                if (info.parentStateInfo == null) {
                    return null;
                } else {
                    return info.parentStateInfo.state;
                }
            }
        }
        ...
        private void performTransitions() {
             ...
             */
            IState destState = null;
            while (mDestState != null) {
                if (mDbg) Log.d(TAG, "handleMessage: new destination call exit");
                /**
                 * Save mDestState locally and onObserve to null
        ...
        private final void processMsg(Message msg) {
            ...
            if (isQuit(msg)) {
                ...
                if (mSm.recordLogRec(msg)) {
                    if (curStateInfo != null) {
                        IState orgState = mStateStack[mStateStackTopIndex].state;
        ...
        private final void invokeExitMethods(StateInfo commonStateInfo) {
            while ((mStateStackTopIndex >= 0) &&
                ...
                IState curState = mStateStack[mStateStackTopIndex].state;
        ...
        private final void moveDeferredMessageAtFrontOfQueue() {
             ...
             * the front of the queue so startStateMachine at the back, which
         ...
         * they are moved.
         *
         * @return index into mStateStack where entering needs to startStateMachine
         */
         ...
         */
        private final StateInfo setupTempStateStackWithStatesToEnter(IState destState) {
            /**
         ...
         */
        private final StateInfo addState(IState state, IState parent) {
            if (mDbg) {
        ...
        /**
         * @see StateMachine#setInitialState(IState)
         */
        private final void setInitialState(IState initialState) {
     ...
     * @param parent the parent of state
     */
    public final void addState(IState state, IState parent) {
    ...
    public final IState getParent(IState child) {
        return mSmHandler.getParent(child);
    }
     ...
     * @param state to add
     */
    public final void addState(IState state) {
     ...
     */
    public final void setInitialState(IState initialState) {
        mSmHandler.setInitialState(initialState);
    }

    /**
     * transition to destination state. Upon returning
     * from receiveMessage the current state's exit will
     ...
     * from receiveMessage we will exit all current
    ...
    /**
     * Get a message and onObserve Message.target = this.
     *
    ...
    /**
     * Get a message and onObserve Message.target = this and what
     *
